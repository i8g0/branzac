...
const ORDER_STORAGE_KEY = 'mahaseel_order_id'
                    ...
                    <form className="checkout-form" onSubmit={handleConfirmOrder}>
                      ...
                      <div className="payment-methods">
                        ...
                        <div className="payment-methods__grid">
                          <button
                            ...
                            onClick={() => { setPaymentMethod('apple_pay'); setPaymentSuccess(false); }}
                          >
                          ...
                          <button
                            ...
                            onClick={() => { setPaymentMethod('card'); setPaymentSuccess(false); }}
                          >
                      ...
                      {(paymentMethod === 'apple_pay' || paymentMethod === 'card') && (
                        <button
                          ...
                          onClick={() => { setPaymentMethod('cash'); setPaymentSuccess(false); }}
                        >
                      ...
                      <button
                        ...
                        disabled={submitting || !selectedTable || items.length === 0 || ((paymentMethod === 'apple_pay' || paymentMethod === 'card') && !paymentSuccess)}
                      >
                        {submitting
                          ? 'جاري الإرسال...'
